...
# >>> entropy.hex()
# '4ad5e01ffe06582456ea39b807bf834b16f6a696c9eec424eb6595c0c80ba04b'
# >>> priv = CTelestaiSecret.from_secret_bytes(entropy)
# >>> addr = P2PKHTelestaiAddress.from_pubkey(priv.pub)
# >>> priv.pub.hex()
...
# >>> from telestai.signmessage import TelestaiMessage, SignMessage
# >>> def signMessage(key: CTelestaiSecret, message: Union[str, TelestaiMessage]):
# ...     ''' returns binary signature '''
# ...     return SignMessage(
# ...         key,
# ...         TelestaiMessage(message) if isinstance(message, str) else message)
# ...
# >>> from telestai.signmessage import VerifyMessage
# >>> def verify(
# ...     message: Union[str, TelestaiMessage],
...
# ...
# >>> signed = SignMessage(priv, TelestaiMessage('helloworld'))
# >>> signed
