...
from telestai.tests.faketelestaiproxy import (
    FakeTelestaiProxy,
    make_txout,
    make_blocks_from_blockhashes,
    make_rpc_batch_request_entry,

    # TODO: import and test with FakeTelestaiProxyException
)


class FakeTelestaiProxyTestCase(unittest.TestCase):
    ...
    def test_constructor_accepts_blocks(self):
        ...
        proxy = FakeTelestaiProxy(blocks=blocks)
    ...
    def test_getrawtransaction(self):
        ...
        proxy = FakeTelestaiProxy(transactions=transactions)
    ...
    def test_getnewaddress_returns_ctelestaiaddress(self):
        proxy = FakeTelestaiProxy()
        address = proxy.getnewaddress()
        self.assertEqual(type(address), P2PKHTelestaiAddress)
