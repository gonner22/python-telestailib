...
class Test_Segwit(unittest.TestCase):
    ...
    def test_p2wpkh_signaturehash(self):
        ...
        address = CBech32TelestaiAddress.from_scriptPubKey(scriptpubkey)
    ...
    def test_p2sh_p2wpkh_signaturehash(self):
        ...
        address = CBase58TelestaiAddress.from_scriptPubKey(redeemscript)
        self.assertEqual(SignatureHash(address.to_redeemScript(), CTransaction.deserialize(unsigned_tx),
    ...
    def test_checkblock(self):
        # (No witness) coinbase generated by Telestai Core
        ...
        commitment_script = telestai.core.WITNESS_COINBASE_SCRIPTPUBKEY_MAGIC + commitment
