...
#
# This file is part of python-telestaib.
#
...
from telestai.base58 import encode
from telestai.core import x
from telestai.core.script import OP_RESERVED
...
class RvnAssetData(object):
    # representation of op_tls_asset data structure
    def __init__(self, data=None):
        ...
        if data is not None:
            if type(data) is str:
                ...
                # data must exclude the op_tls_asset bytecode itself
            ...
            try:
                ...
                assert (prefix.decode("ascii") == "tls")
            ...
            if self.asset_type in ("new", "admin", "reissue", "transfer"):
                ...
                self._asset_name = struct.unpack(
                    '< {}s'.format(name_length), unpack_data)
