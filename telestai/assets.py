...
TELESTAI_NAMES = re.compile("^TLS$|^TELESTAI$|^TELESTAI$")
...
class CAsset(object):
    ...
    def name(self, namestr):
        ...
        if TELESTAI_NAMES.match(namestr):
            raise InvalidAssetName("not allowed (TLS/TELESTAI/TELESTAI")
        ...
        # unique tag '#' is not counted when checking length, as telestai source
...
# https://github.com/Telestai-Project/Telestai/blob/master/assets/asset_metadata_spec.md
