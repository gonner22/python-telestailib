...
import telestai
from telestai.segwit_addr import encode, decode
import sys
_bchr = chr
_bord = ord
if sys.version > '3':
...
class CBech32Data(bytes):
    ...
    def __new__(cls, s):
        """from bech32 addr to """
        witver, data = decode(telestai.params.BECH32_HRP, s)
    ...
    def __str__(self):
        """Convert to string"""
        return encode(telestai.params.BECH32_HRP, self.witver, self)
