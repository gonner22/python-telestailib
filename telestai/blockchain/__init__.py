...
# Copyright (C) 2020 The telestai-blockchain-parser developers
#
# This file is part of telestai-blockchain-parser.
#
# It is subject to the license terms in the LICENSE file found in the top-level
# directory of this distribution.
#
# No part of telestai-blockchain-parser, including this file, may be copied,
...
from telestai.core import CBlock
from .index import DBBlockIndex
from .utils import format_hash


# Constant separating blocks in the .blk files
TELESTAI_CONSTANT = b"\x54\x45\x4c\x45"  # TLS


def get_files(path):
    """
    Given the path to the .telestai directory, returns the sorted list of .blk
...
def get_blocks(blockfile):
    ...
    with open(blockfile, "rb") as f:
        ...
        while offset < (length - 4):
            if raw_data[offset:offset+4] == TELESTAI_CONSTANT:
                offset += 4
...
class Blockchain(object):
    ...
    def get_ordered_blocks(self, index, start=0, end=None, cache=None):
        ...
        # "-reindex"ing the telestaid block data. This leads to at least two
