...
from evrmore.base58 import encode as b58encode
from evrmore.base58 import decode as b58decode
...
template_default = "EVRBurnTest"

parser = argparse.ArgumentParser(
    description='Generate a Evrmore burn address.')
...
if __name__ == "__main__":
    ...
    try:
        burn_address = CEvrmoreAddress(burn(template))
        print(burn_address)
